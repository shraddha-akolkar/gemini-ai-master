  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Modal Header */}
          <div className="relative bg-gradient-to-r from-purple-500 to-blue-500 p-6 rounded-t-2xl">
            <button
              onClick={onClose}
              className="absolute top-4 right-4 p-1.5 hover:bg-white/20 text-white rounded-lg transition-colors"
            >
              <X className="w-6 h-6" />
            </button>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-xl font-semibold hover:from-purple-600 hover:to-blue-600 transition-all shadow-md hover:shadow-lg"
            >
              Sign In
            </button>
